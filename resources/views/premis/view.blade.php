                    ...
                    <table class="table table-striped">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td width="20%">{{ $sewa->sya_desc }}</td>
                                <td width="25%">{{ $sewa->fas_desc }}</td>
                                <td width="10%">@tarikh($sewa->peny_mula) - @tarikh($sewa->peny_tamat)</td>
                        ...
                        <tfoot>
                            <tr>
                                <td colspan="5" class="text-right">Jumlah Sebulan (RM)</td>
